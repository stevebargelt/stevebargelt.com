...
url: /2016/10/07/automated-build-system-docker-in-azure/
---
### Introduction
...
{{< blog-img src="/assets/buildSystem_01" >}}
...
We are going to create a new resource group and name it dockerBuild, I'm in Seattle so I'm choosing westus as the location. 

{{< blog-img src="/assets/azure-vm-basics" >}}
...
{{< blog-img src="/assets/azure-pick-plan" >}}
...
{{< blog-img src="/assets/azure-vm-settings" >}}
...
{{< blog-img src="/assets/host-a-record" >}}
...
{{< blog-img src="/assets/azure-inbound-rules" >}}
...
{{< blog-img src="/assets/azure-docker-settings" >}}
